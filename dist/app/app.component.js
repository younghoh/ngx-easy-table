System.register(['angular2/core', "./services/filters-service", "./pipes/header-pipe", "./pipes/pagination-pipe", "./components/header/header.component", "./components/pagination/pagination.component", "./services/config-service", "./services/resource-service", "./services/http-service", 'rxjs/add/operator/map', "./components/global-search/global-search.component", "./pipes/global-search-pipe", "./components/dropdown/csv-export.component", "angular2/http"], function(exports_1, context_1) {
    ...
    var core_1, filters_service_1, header_pipe_1, pagination_pipe_1, header_component_1, pagination_component_1, config_service_1, resource_service_1, http_service_1, global_search_component_1, global_search_pipe_1, csv_export_component_1, http_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    core_1.Component({
                        selector: 'ng2-table',
                        bindings: [http_service_1.HttpService, filters_service_1.FiltersService, resource_service_1.ResourceService, config_service_1.ConfigService, http_1.HTTP_PROVIDERS],
